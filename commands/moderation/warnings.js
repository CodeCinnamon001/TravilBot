    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option.setName("reason").setDescription("Provide a reason.").setRequired(false)
        )
        .addStringOption((option) =>
          option.setName("evidence").setDescription("Provide evidence.").setRequired(false)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addIntegerOption((option) =>
          option.setName("id").setDescription("Provide the warning's id.").setRequired(false)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
